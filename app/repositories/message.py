...
class MessageRepository:
    ...
    async def create_message(
        ...
        try:
            ...
            item = {
                ...
                'sender_role': {'S': sender_role.value},
                'content': {'S': content},
                'is_active': {'BOOL': True},
                'created_at': {'S': now}
            }
    ...
    async def get_user_messages(
        ...
        """
        Get all messages for a user using GSI1.
        ...
        try:
            ...
            logger.error(f"Error getting user messages for user {user_id}: {e}")
            raise
